...
```{r}
par(mfrow=c(1,2))
initialTestHist = hist(INITIAL.TEST.SCORE, main = "Histogram of Initial Test Scores", ylab = "Frequency", xlab = "Test Score")
finalTestHist = hist(FINAL.TEST.SCORE, main = "Histogram of Final Test SCores", xlab = "Test Score")
```
...
#Proportion of students who are differing levels of forgetful at start of study
prop.0.initial = initialForgetfulTally[1]/79; prop.0.initial
prop.1.initial = initialForgetfulTally[2]/79; prop.1.initial
prop.2.initial = initialForgetfulTally[3]/79; prop.2.initial

#Proportion of students who are differing levels of forgetful at end of study
prop.0.final = finalForgetfulTally[1]/79; prop.0.final
prop.1.final = finalForgetfulTally[2]/79; prop.1.final
prop.2.final = finalForgetfulTally[3]/79; prop.2.final
```
